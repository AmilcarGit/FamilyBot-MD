...
<body class="p-4 md:p-8">
    ...
    <div id="login" class="max-w-md mx-auto mt-32 animate__animated animate__fadeIn">
        <div class="glass p-8 rounded-2xl text-center border-t-4 border-pink-600">
            ...
            <button type="button" id="login-btn" onclick="entrar()" class="btn-cyber w-full py-3 text-white font-bold tracking-widest uppercase cursor-pointer">AUTENTICAR SISTEMA</button>
        </div>
    </div>
    ...
    <script>
        ...
        window.onload = () => {
            ...
            if (localStorage.getItem('yui_token')) entrar();
        };
        ...
        async function entrar() {
            ...
            const val = input.value || currentToken;
            
            if (!val) return alert('POR FAVOR INGRESA EL TOKEN');
