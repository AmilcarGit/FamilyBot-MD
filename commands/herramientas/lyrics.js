...
export default async function lyrics({ sock, chatId, args, m, config }) {
  ...
  try {
    await sock.sendMessage(chatId, { text: `🔍 Buscando la letra de *"${query}"*...` }, { quoted: m })
    ...
    await sock.sendMessage(chatId, { text: textoLyrics }, { quoted: m })
